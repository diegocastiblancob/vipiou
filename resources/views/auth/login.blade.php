    ...
    <div class="row justify-content-center mt-5 mb-5">
        <div class="col-md-6 mt-3 mb-5">
            <div class="card cajas">
                <h4 class="text-center text-light">{{ __('Inicio de sesión') }}</h4>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right text-light">{{ __('Correo eletrónico') }}</label>
